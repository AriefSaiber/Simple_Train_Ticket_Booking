        ...
        child: Column(
          ...
          children: [
            ...
            summaryComp().textComp(
                title: 'Arrival Time', value: gCtrl.addHoursToTime(gCtrl.selectedDepartTime.value, 2), context),
            summaryComp().textComp(
                title: 'Departure Date',
                value: gCtrl.convertDateTimeToString(gCtrl.selectedDepartDate.value!),
                context),
            summaryComp().textComp(title: 'Returning Seat', value: gCtrl.selectedDepartSeat.value, context),
            Divider(),
            Center(
                child: Text(
              'Returning Detail',
            ...
            summaryComp().textComp(title: 'Returning Time', value: gCtrl.selectedReturnTime.value, context),
            summaryComp().textComp(
                title: 'Arrival Time', value: gCtrl.addHoursToTime(gCtrl.selectedReturnTime.value, 2), context),
            summaryComp().textComp(
                title: 'Returning Date',
                value: gCtrl.convertDateTimeToString(gCtrl.selectedReturnDate.value!),
                context),
            summaryComp().textComp(title: 'Returning Seat', value: gCtrl.selectedReturnSeat.value, context),
            Row(
